const burger = document.getElementById("portfolio-burger-menu");
...
const menuItems = document.querySelectorAll("#p-menu .menu-item[data-section]");
...
/* Default: nothing active when hero is visible */
const sectionMap = [
  { el: document.getElementById("metadata"), key: "metadata" },
  { el: document.getElementById("linux"),    key: "linux"    },
  { el: document.getElementById("cyber"),    key: "cyber"    },
  { el: document.getElementById("database"), key: "database" },
  { el: document.getElementById("web"),      key: "web"      },
];
...
/* Clear active when wormhole hero is visible */
const heroIO = new IntersectionObserver(entries => {
  if (entries[0].isIntersecting) menuItems.forEach(el => el.classList.remove("active"));
}, { threshold: 0.2 });

const heroEl = document.getElementById("wormhole-hero");
